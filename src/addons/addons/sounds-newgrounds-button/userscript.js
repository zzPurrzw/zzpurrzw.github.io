...
export default async function() {
  ...
  async function openNewgroundsPopup() {
    ...
    searchBtn.setAttribute("style", "border: none; border-radius: 5px; padding: 10px 20px; margin: 10px 0 0; background: #1FFF79; cursor: pointer; font-weight: 600; font-size: 0.85rem; color: white;");
